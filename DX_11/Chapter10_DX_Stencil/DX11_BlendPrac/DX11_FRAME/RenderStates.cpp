...
ID3D11BlendState* RenderStates::PlusBS = 0;
...
void RenderStates::InitAll(ID3D11Device* device)
{
	...
	D3D11_BLEND_DESC plusDesc = { 0 };
	plusDesc.AlphaToCoverageEnable = false;
	plusDesc.IndependentBlendEnable = false;
	...
	plusDesc.RenderTarget[0].SrcBlendAlpha = D3D11_BLEND_ZERO;
	plusDesc.RenderTarget[0].DestBlendAlpha = D3D11_BLEND_ZERO;
	plusDesc.RenderTarget[0].BlendOpAlpha = D3D11_BLEND_OP_ADD;
	plusDesc.RenderTarget[0].RenderTargetWriteMask = D3D11_COLOR_WRITE_ENABLE_ALL;

	HR(device->CreateBlendState(&plusDesc, &PlusBS));
